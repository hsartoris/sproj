...
\begin{figure}[h]
	...
	\label{fig:3neur_run}
\end{figure}\noindent
In \figref{fig:3neur_run}, we examine the internal operation of the trained 
model on a single piece of data.
The final layer handles turning the information from \ref{subfig:3neur_out1} 
into a prediction by multiplying the matrix found in \ref{subfig:3neur_flayer} 
with \ref{subfig:3neur_out1} to produce \ref{subfig:3neur_outf}, which is then 
