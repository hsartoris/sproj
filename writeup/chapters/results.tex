...
We demonstrate this aspect of our architecture by training a network on an empty 
dataset paired with the same adjacency matrix (as in 
\figref{fig:2simplex+adjacency}) throughout.
