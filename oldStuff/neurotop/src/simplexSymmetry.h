...
/************************************************************************/
/*! \file header file containing the simplex class
*/
...
/*
* This is a directed simplex. A directed simplex consist of a collectoin of vertices (order do not matters).
*/
class simplex
{
public:
    ...
    */
    ...
    /*
    * This procedure compute intersection of two simplices (two sets of vertices).
    */
    ...
    */
    ...
    /*
    * Iterator for coboundary of a simplex.
    */
    ...
    */
    ...
    /*
    * Operator that write simplex to a stream. Vertices are written in arbitrary order, typically in increasing one.
    */
    ...
    */
    unsigned int numberInCmplx() const {return this->numberInComplex;}
    ...
    */
    ...
    /*
    * Procedure that returns vertices in the current simplex (in any order).
    */
