...
def dumpData(fdir, printout=True):
    ...
    print("batchSize: " + str(batchSize), f=file)
    print("timesteps: " + str(timesteps), f=file)
    print("trainingSteps: " + str(trainingSteps), f=file)
    print("runNumber: " + str(runNumber), f=file)
    print("initLearningRate: " + str(initLearningRate), f=file)
    f.close()
